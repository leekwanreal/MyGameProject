...
public class EventHandler {
    ...
    public void checkEvent() {
        ...
        if (canTouchEvent) {
            ...
            if ((hit(0, 27, 22, "any") || hit(0, 28, 22, "any") || hit(0, 29, 22, "any")) &&
            ...
            if ((hit(0, 20, 23, "any") || hit(0, 21, 23, "any")) && gp.setMonster3 == false) {
                gp.setMonster3 = true;
                gp.aSetter.setMonster3();
            }

            if ((hit(0, 28, 28, "any") || hit(0, 29, 28, "any")) && gp.setMonster4 == false) {
                gp.setMonster4 = true;
                gp.aSetter.setMonster4();
            }

            if ((hit(0, 27, 34, "any") || hit(0, 27, 35, "any") || hit(0, 27, 36, "any") ||
            hit(0, 27, 37, "any") || hit(0, 27, 38, "any") || hit(0, 27, 39, "any")) &&
    ...
    public void talkToNPC(int gameState) {
        if (gp.keyH.enterPressed == true) {
            ...
            switch (talkToNPCindex) {
                case 0:
                    gp.ui.currentDialogue = "Eva: Help me please!";
                    break;
                case 1:
                    gp.ui.currentDialogue = "Eva: I am trapped here because the monsters \nhave taken over the school!";
                    break;
                case 2:
                    gp.ui.currentDialogue = "Eva: You need to rescue the school from the \nmonsters!";
                    break;
            }
            talkToNPCindex++;
